package com.emrekirman.glaceon.gateway.common.exception.handler;
...
import com.emrekirman.glaceon.gateway.common.translator.TranslatorService;
...
public class ExceptionHandlers {
    ...
    @ResponseBody
    public String handle(CustomAuthorizationException exception) {
        return translator.translate(exception.getMessage());
    }
    ...
    public String handle(Exception e) {
        return translator.translate("operation.failed");
    }
